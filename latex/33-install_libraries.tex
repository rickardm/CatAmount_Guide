...
the introduction of \verb=pip= in Python 3.4 and later.

We will specifically be using \verb=python3 -m pip= command to make sure we
...
like this. You will do these commands in a command prompt (\verb=Start > Run > cmd=).

First, make sure our \verb=pip= command itself is up to date:
